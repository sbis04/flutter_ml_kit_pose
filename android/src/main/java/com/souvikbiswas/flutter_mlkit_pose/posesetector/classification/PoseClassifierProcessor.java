...
import com.souvikbiswas.flutter_mlkit_pose.posesetector.PoseDataStorage;
...
//      result.add(lastRepResult);
        ...
        if (!pose.getAllPoseLandmarks().isEmpty()) {
            ...
            // -----------------------------------------------------------------------------------
            //
            PoseDataStorage.setData(maxConfidenceClass, String.format(Locale.US, "%.2f", poseAccuracy));

//      MainActivity.listeners.put(listener, new Runnable() {
//        @Override
//        public void run() {
//          if (MainActivity.listeners.containsKey(listener)) {
